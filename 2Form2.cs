...
namespace UrbanHeatIsland
{
    ...
    {
        static bool IsComparing, IsChartLoaded, IsSecondChartLoaded, IsFormLoaded, IsReady = true, IsInfoRequest;
        DateTime finishDateLast, startDateLast;
        Graphics cGraphics;
        ...
        {
            return Forecast(DateTime.Now, forecastingMeasure);
        }
        float Forecast(DateTime selectedDate, string forecastingMeasure)
        {
